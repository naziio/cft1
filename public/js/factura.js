    ...
    $('#btn-save').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var factura = '<tr id="factura' + data.id + '"><td>' + data.id + '</td><td>' + data.razon_social + '</td><td>' + data.subtotal + '</td><td>'+ data.recargo + '</td><td>' + data.num_factura +  '</td><td>' + data.monto_exento + '</td><td>' + data.descuentos + '</td><td>' + data.impuesto_especifico + '</td><td>' + data.neto + '</td><td>'+ data.iva + '</td><td>'+ data.total_concepto + '</td><td>'+ data.observacion + '</td><td>';
